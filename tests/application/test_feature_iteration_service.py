...
def test_feature_iteration_service_executes_through_port_boundary() -> None:
    """The service should normalize requests through the feature-iteration port."""
    executor = _FakeFeatureIterationExecutor()

    result = FeatureIterationService(executor).run(_build_request())
