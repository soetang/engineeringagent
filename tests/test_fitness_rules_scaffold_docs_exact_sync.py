...
def test_manifest_includes_scaffold_docs_exact_sync_rule() -> None:
...
def test_exact_sync_checker_fails_when_docs_and_template_differ(tmp_path: Path) -> None:
...
def test_exact_sync_checker_passes_when_docs_and_template_match(tmp_path: Path) -> None:
