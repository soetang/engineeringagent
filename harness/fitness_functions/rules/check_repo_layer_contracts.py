...
DELETED_MODULE_PATHS = {
    ...
    "src/engineeringagent/application/feature_iteration_runtime_contracts.py",
    "src/engineeringagent/application/feature_iteration_runtime_pipeline.py",
    "src/engineeringagent/application/implementation_step.py",
    "src/engineeringagent/application/checks/runtime.py",
    "src/engineeringagent/application/feature_iteration_runtime/service.py",
