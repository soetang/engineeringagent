...
from engineeringagent.scaffolding.filesystem import (
    upsert_text_file,
    write_file_if_missing,
)
from engineeringagent.scaffolding.models import FileWriteResult, InitRequest, InitResult
...
from engineeringagent.scaffolding.templates import (
    AGENTS_MD_SNIPPET,
    ...
    def _create_or_append_agents_md(
        ...
        if AGENTS_MD_START_MARKER in current:
            return FileWriteResult(
                path=agents_path,
                status="skipped",
                reason="engineeringagent guidance already present",
            )
