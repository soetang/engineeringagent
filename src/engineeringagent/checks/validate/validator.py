...
def _append_legacy_harness_contract_file_issues(
    ...
    *,
    ...
    As of FEAT-098, `engineeringagent validate` no longer fails solely due to the
    presence of legacy harness contract files (the old gates/reviewers YAML
    contracts).
    """

    del messages, project_root, gates_path, reviewers_path
